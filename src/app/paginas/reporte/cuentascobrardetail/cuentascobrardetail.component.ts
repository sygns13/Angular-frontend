...
@Component({
  selector: 'app-cuentascobrardetail',
  templateUrl: './cuentascobrardetail.component.html',
  styleUrls: ['./cuentascobrardetail.component.scss'],
  providers: [ConfirmationService, MessageService],
  encapsulation: ViewEncapsulation.None,
})
export class CuentascobrardetailComponent implements OnInit{
  ...
  clsEstadoPagado: any = {name: 'TODOS', code: 'Z'};
  ...
  constructor(private breadcrumbService: AppBreadcrumbService, private changeDetectorRef: ChangeDetectorRef , private ventaService: VentaService, 
    ...
    this.breadcrumbService.setItems([
      { label: 'Reportes' },
      { label: 'Reporte de Pagos Detallados', routerLink: ['/reporte/cobro-detallado'] }
    ]);
  ...
  listarPageMain(p: number, s:number) {
    ...
    this.ventaService.getVentasCobrosDetallados(this.filtroVenta, p ,s).subscribe(data => {
  ...
  printPDF(): void{
    this.exportsService.exportCuentasCobrarDetailPDF(this.filtroVenta).subscribe(data => {
      ...
      a.href = fileURL;
      a.download = 'CuentasCobrarDetallado.pdf';
      a.click();
  ...
  printXLS(): void{
    this.exportsService.exportCuentasCobrarDetailXLSX(this.filtroVenta).subscribe(data => {
      ...
      document.body.appendChild(a);
      a.href = fileURL;
      a.download = 'CuentasCobrarDetallado.xlsx';
      a.click();
      //window.open(fileURL);
    });
  }
