...
@Component({
  selector: 'app-ingresosventas',
  templateUrl: './ingresosventas.component.html',
  styleUrls: ['./ingresosventas.component.scss'],
  providers: [ConfirmationService, MessageService],
  encapsulation: ViewEncapsulation.None,
})
export class IngresosventasComponent implements OnInit{
  ...
  constructor(private breadcrumbService: AppBreadcrumbService, private changeDetectorRef: ChangeDetectorRef , private ventaService: VentaService, 
    ...
    this.breadcrumbService.setItems([
      { label: 'Reportes' },
      { label: 'Reporte de Ingresos por Ventas', routerLink: ['/reporte/ingresos-ventas'] }
    ]);
  ...
  listarPageMain(p: number, s:number) {
    ...
    this.ventaService.getIngresosVentas(this.filtroVenta, p ,s).subscribe(data => {
      this.ventas = data.ventas.content;
      this.isFirst = data.ventas.first;
      this.isLast = data.ventas.last;
      this.numberElements = data.ventas.numberOfElements;
      this.first = (p * s);
      this.last = (p * s) + this.numberElements;
      this.totalRecords = data.ventas.totalElements;
      this.loading = false;
  ...
  printPDF(): void{
    this.exportsService.exportIngresosVentasPDF(this.filtroVenta).subscribe(data => {
  ...
  printXLS(): void{
    this.exportsService.exportIngresosVentasXLSX(this.filtroVenta).subscribe(data => {
      ...
      document.body.appendChild(a);
      a.href = fileURL;
      a.download = 'IngresosVentas.xlsx';
      a.click();
      //window.open(fileURL);
    });
  }
