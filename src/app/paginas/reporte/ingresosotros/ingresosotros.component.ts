...
@Component({
  selector: 'app-ingresosotros',
  templateUrl: './ingresosotros.component.html',
  styleUrls: ['./ingresosotros.component.scss'],
  providers: [ConfirmationService, MessageService],
  encapsulation: ViewEncapsulation.None,
})
export class IngresosotrosComponent implements OnInit {
  ...
  constructor(private breadcrumbService: AppBreadcrumbService, private changeDetectorRef: ChangeDetectorRef , private ingresoSalidaCajaService:IngresoSalidaCajaService,
    ...
    this.breadcrumbService.setItems([
      { label: 'Reportes' },
      { label: 'Reporte de Ingresos por Otros Conceptos', routerLink: ['/reporte/ingresos-otros'] }
    ]);
  ...
  listarPageMain(p: number, s:number, almacen_id: number = 0) {
    ...
    this.ingresoSalidaCajaService.getIngresosCaja(this.filtroGeneral).subscribe(data => {
      this.ingresoSalidaCajas = data.ingresos.content;
      this.isFirst = data.ingresos.first;
      this.isLast = data.ingresos.last;
      this.numberElements = data.ingresos.numberOfElements;
      this.first = (p * s);
      this.last = (p * s) + this.numberElements;
      this.totalRecords = data.ingresos.totalElements;
      this.loading = false;
  ...
  printPDF(): void{
    this.exportsService.exportIngresosOtrosPDF(this.filtroGeneral).subscribe(data => {
  ...
  printXLS(): void{
    this.exportsService.exportIngresosOtrosXLSX(this.filtroGeneral).subscribe(data => {
