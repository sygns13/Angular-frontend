...
@Component({
  selector: 'app-egresoscompras',
  templateUrl: './egresoscompras.component.html',
  styleUrls: ['./egresoscompras.component.scss'],
  providers: [ConfirmationService, MessageService],
  encapsulation: ViewEncapsulation.None,
})
export class EgresoscomprasComponent implements OnInit{
  ...
  listarPageMain(p: number, s:number) {
    ...
    this.entradaStockService.getEgresosCompras(this.filtroEntradaStock, p ,s).subscribe(data => {
      this.entradaStocks = data.compras.content;
      this.isFirst = data.compras.first;
      this.isLast = data.compras.last;
      this.numberElements = data.compras.numberOfElements;
      this.first = (p * s);
      this.last = (p * s) + this.numberElements;
      this.totalRecords = data.compras.totalElements;
      this.loading = false;
  ...
  printPDF(): void{
    this.exportsService.exportEgresosComprasPDF(this.filtroEntradaStock).subscribe(data => {
  ...
  printXLS(): void{
    this.exportsService.exportEgresosComprasXLSX(this.filtroEntradaStock).subscribe(data => {
      ...
      document.body.appendChild(a);
      a.href = fileURL;
      a.download = 'EgresosCompras.xlsx';
      a.click();
      //window.open(fileURL);
    });
  }
