...
export class CuentascobrarComponent implements OnInit{
  ...
  constructor(private breadcrumbService: AppBreadcrumbService, private changeDetectorRef: ChangeDetectorRef , private ventaService: VentaService, 
    ...
    this.breadcrumbService.setItems([
      { label: 'Reportes' },
      { label: 'Reporte de Pagos de Ventas', routerLink: ['/reporte/cobro-ventas'] }
    ]);
  ...
  printPDF(): void{
    this.exportsService.exportCuentasCobrarPDF(this.filtroVenta).subscribe(data => {
  ...
  printXLS(): void{
    this.exportsService.exportCuentasCobrarXLSX(this.filtroVenta).subscribe(data => {
