    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items: [
                    {label: 'Registro de Movimientos', icon: 'pi pi-fw pi-sort-numeric-down-alt', routerLink: ['/caja/movimientos-caja']},
                    {label: 'Caja Diaria', icon: 'pi pi-fw pi-table', routerLink: ['/caja/caja-diaria']},
