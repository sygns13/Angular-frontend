...
@Component({
    ...
    template: `
        <div class="layout-footer p-d-flex p-ai-center p-p-4 p-shadow-2">
            ...
            <div class="copyright text-center">© 2021 <a href="https://www.bcs.com/nosotros"   target="_blank"    >Building Computer Solutions</a>,  <i class="fa fa-desktop"></i> Construyendo Soluciones Informáticas</div>
